...
#define CS_GYRO SPI_CHIP_SELECT_1

//指定坐标轴替换
#define BODY_X_IS_BMI ('X')
#define BODY_Y_IS_BMI (-'Y')
#define BODY_Z_IS_BMI (-'Z')
...
extern int bmi088_accel_self_test(void);
extern int bmi088_gyro_self_test(void);
extern int bmi088_accel_init(void);
extern int bmi088_gyro_init(void);
